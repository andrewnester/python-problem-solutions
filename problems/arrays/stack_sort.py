...
N denoting the size of the stack. Then in the next line are N space
separated values which are pushed to the the stack.
...
From: http://practice.geeksforgeeks.org/problems/sort-a-stack/1
"""
